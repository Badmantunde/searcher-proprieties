export default function DevelopedHero() {
  return (
    <section
      id="developed-hero"
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-[1280px] flex-col items-start px-6 pt-36 pb-20 text-left sm:px-10 sm:pt-44 sm:pb-24 lg:px-16 lg:pt-52 lg:pb-28">
        ...
        >
          <span className="text-white">Crafted Spaces</span>
          <br />
          <span className="text-brand-teal">Designed for Modern Living</span>
        </h1>
        ...
        >
          Discover our collection of completed luxury residences, where
          elegance meets comfort and prestige.
        </p>
      </div>
    </section>
  );
